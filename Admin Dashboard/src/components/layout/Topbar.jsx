...
import { Bell, Search, User, Sun, Moon, Download } from 'lucide-react';
    ...
    return (
        <header className="h-20 bg-white dark:bg-card border-b border-neutral-100 dark:border-border sticky top-0 z-40 px-8 flex items-center justify-between transition-colors duration-300">
            ...
            <div className="flex items-center gap-4">
                <button className="p-2 rounded-full hover:bg-neutral-100 dark:hover:bg-muted transition-colors text-muted-foreground hover:text-foreground" title="Download Report">
